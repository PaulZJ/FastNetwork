...
import com.zj.fastnet.common.handler.DownloadProgressHandler;
 ...
 *
 * the specific ResponseBody to record downloaded bytes
 */
            ...
            public long read(Buffer sink, long byteCount) throws IOException {
                ...
                if (downloadProgressHandler != null) {
                    downloadProgressHandler
                            .obtainMessage(Const.UPDATE,
                                    new Progress(totalBytesRead, responseBody.contentLength()))
                            .sendToTarget();
                }
                return bytesRead;
            }
